...
public class SituationalDataServiceParameters {
	...
	// Constructor assigns values by default for testing and backwards
	// compatibility
	public SituationalDataServiceParameters() {
		...
		servicePredictedTrafficFromCellNetLongitude = BigInteger
				.valueOf(45350000);
		servicePredictedTrafficFromCellNetLatitude = BigInteger
				.valueOf(9100000);
	...
	/**
	 * @param serviceTrafficSocialNetworkCityName
	 *            the serviceTrafficSocialNetworkCityName to set
	 */
	public void setServiceTrafficSocialNetworkCityName(
			String serviceTrafficSocialNetworkCityName) {
	...
	/**
	 * @param serviceTrafficSocialNetworkStateName
	 *            the serviceTrafficSocialNetworkStateName to set
	 */
	public void setServiceTrafficSocialNetworkStateName(
			String serviceTrafficSocialNetworkStateName) {
	...
	/**
	 * @param serviceTrafficSocialNetworkStateAbbr
	 *            the serviceTrafficSocialNetworkStateAbbr to set
	 */
	public void setServiceTrafficSocialNetworkStateAbbr(
			String serviceTrafficSocialNetworkStateAbbr) {
	...
	/**
	 * @param serviceTrafficSocialNetworkLatitude
	 *            the serviceTrafficSocialNetworkLatitude to set
	 */
	public void setServiceTrafficSocialNetworkLatitude(
			long serviceTrafficSocialNetworkLatitude) {
	...
	/**
	 * @param serviceTrafficSocialNetworkLongitude
	 *            the serviceTrafficSocialNetworkLongitude to set
	 */
	public void setServiceTrafficSocialNetworkLongitude(
			long serviceTrafficSocialNetworkLongitude) {
	...
	/**
	 * @param servicePredictedTrafficFromCellNetLatitude
	 *            the servicePredictedTrafficFromCellNetLatitude to set
	 */
	public void setServicePredictedTrafficFromCellNetLatitude(
			BigInteger servicePredictedTrafficFromCellNetLatitude) {
	...
	/**
	 * @param servicePredictedTrafficFromCellNetLongitude
	 *            the servicePredictedTrafficFromCellNetLongitude to set
	 */
	public void setServicePredictedTrafficFromCellNetLongitude(
			BigInteger servicePredictedTrafficFromCellNetLongitude) {
