...
(fact "A monitor must create norm instances if the proper facts are added."
     (extract-norm-id (mon/status (init-moni mon-1))) => nil #_:norm-1
     (extract-norm-id (mon/status (init-moni mon-2))) => :norm-2 
     (extract-norm-id (mon/status (init-moni mon-3))) => :norm-3)
